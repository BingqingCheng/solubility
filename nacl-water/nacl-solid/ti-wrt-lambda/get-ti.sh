...
tail -n +1000 T-$t-l-$a/para.out | awk '!/#/{print $6-$7}' | autocorr -maxlag 100 | head -n 1 | awk -v a=$a '{print a, 627.5*$2/256, 627.5*$6/256}';
fi
done
