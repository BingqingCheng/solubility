...
def main(sprefix="Sk", straj="out", sbins=8):
    ...
    # Outputs
    ofile_AA = open(sprefix+'-NN-real.dat',"ab")
    ofile_AB = open(sprefix+'-NC-real.dat',"ab")
    ofile_BB = open(sprefix+'-CC-real.dat',"ab")
    ...
    while True:
        ...
        sk_AA, sk_AB, sk_BB = Sk(names, sq, kgridbase, 'N', 'C')
